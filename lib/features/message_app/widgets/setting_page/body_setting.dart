...
import 'package:tomiru_social_flutter/features/social_group/Screens/group_members.dart';
import 'package:tomiru_social_flutter/features/social_group/Widgets/add_member.dart';
import 'package:tomiru_social_flutter/common/widgets/ui/customAppBar.dart';

class BodySetting extends StatefulWidget {
  final bool isAdmin;
  const BodySetting({Key? key, required this.isAdmin}) : super(key: key);
