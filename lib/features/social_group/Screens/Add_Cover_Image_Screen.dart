...
class _AddDescriptionScreenState extends State<AddDescriptionScreen> {
  ...
  void saveAndNext() {
    // Save the description using SocialGroupController
    final description = _descriptionController.text;
    if (description.isNotEmpty) {
      Get.find<SocialGroupController>().setDescription(description);
      widget.nextPage(); // Move to the next page
    } else {
      Get.snackbar('Lỗi', 'Vui lòng nhập mô tả trước khi tiếp tục.');
    }
  }
        ...
        child: Column(
          children: [
            ...
            CustomButton(
              content: "Xong",
              action: () {
                Get.find<SocialGroupController>().createGroup();
              },
              isEnabled: true,
              backgroundColor: Colors.blue,
              height: 48,
