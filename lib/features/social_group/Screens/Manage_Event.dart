...
import 'package:tomiru_social_flutter/features/social_group/Screens/Event_Test.dart';
import 'package:tomiru_social_flutter/features/social_group/Screens/Pick_Group.dart';
import 'package:tomiru_social_flutter/features/social_group/Widgets/square_button.dart';

class ManageEvent extends StatefulWidget {
  final bool showEventExist;

  const ManageEvent({this.showEventExist = false, super.key});
            ...
            child: SquareButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PickGroup(),
                  ),
                );
              },
