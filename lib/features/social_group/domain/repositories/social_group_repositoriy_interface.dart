...
abstract class SocialGroupRepositoryInterface extends RepositoryInterface {
  Future<GroupModel> createGroup(GroupRequest request);
  Future<GroupModel> getGroupById(int id);
  ...
  Future<ResponseModel> acceptJoinGroup(AcceptUserToGroupRequest id);
