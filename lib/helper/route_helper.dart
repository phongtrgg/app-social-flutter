...
//!
  ...
  static String getSocicalNetworkRoute(String page) =>
      '$socialNetwork?page=$page';
  ...
  static String getGroupScreen(String indexPage) => '$group?page=$indexPage';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: socialNetwork,
        page: () => SocialNetwork(
              initialPageIndex: int.parse(Get.parameters['page']!),
            )),
    GetPage(
      name: business,
